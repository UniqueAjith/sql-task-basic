...
INSERT INTO persons (name, age) VALUES ("Ajith", 19);
...
INSERT INTO hobbies (person_id, name) VALUES (5, "coding");
...
SELECT persons.name,hobbies.name FROM persons JOIN hobbies ON persons.id = hobbies.person_id WHERE 
